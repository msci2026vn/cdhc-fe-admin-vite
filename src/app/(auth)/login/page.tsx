  ...
  return (
    <Card className="w-full max-w-md shadow-xl">
      ...
      <CardContent className="space-y-6">
        ...
        {/* Debug Panel */}
        <div className="fixed bottom-4 right-4 bg-black/60 backdrop-blur-md text-green-400 p-4 rounded-lg text-xs z-50 font-mono max-w-xs shadow-2xl border border-white/10">
